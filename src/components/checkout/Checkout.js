...
function Checkout() {
  ...
  const [countryObj, setCountryObj] = useState(
    countries[12] ? countries[12] : countries[12]
  );
  ...
  // ================================================================
  let shippingCountry = countryObj?.label;

  // console.log("Selected country from obj: ", countryObj?.label)

  // ================================================================

  cart.itemsPrice = cart.cartItems
    .reduce((acc, item) => acc + item.obj.bookingDetails.price * item.qty, 0)
    .toFixed(2);
  ...
  useEffect(() => {
    ...
    if (success) {
      ...
      localStorage.setItem("emailSent", JSON.stringify(1));
    ...
    if (paymentMethod === "Credit Card") {
      ...
      dispatch(
        createOrder({
          ...
          cardDetails: cart.cardDetails,
          paymentMethod: cart.paymentMethod,
          itemsPrice: cart.itemsPrice,
          shippingPrice: cart.shippingPrice,
          freePills: cart.freePills,
          ...
          <Form onSubmit={submitHandler}>
            <Row>
              <Col md={7}>
                ...
                <Row className={styles.shippingForm}>
                  <Col md={6}>
                    <TextField
                      className="py-2"
                      id="standard-basic"
                  ...
                  <ListGroup variant="flush">
                    <ListGroup.Item>
                      {cartItems.map((item, i) => (
                        <Row>
                          <Col md={5}>Item {i + 1}:</Col>
                          <Col md={7}>
                            {item.name}, {item.obj.bookingDetails.tablets}{" "}
                            Pills, ({item.obj.bookingDetails.strength}mg)
                          </Col>
                        </Row>
                      ))}
                    </ListGroup.Item>
                    ...
                    <ListGroup.Item>
                      ...
                      >
                        When you choose PayPal or Bitcoin as your payment
                        option, you will get a call from our customer care team.
                        You need to follow the instructions to complete the
                        payment process.
                      </p>
                    </ListGroup.Item>
